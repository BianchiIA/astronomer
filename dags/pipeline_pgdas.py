...
def pgdas_etl_test(**kwargs):
    ...
    def zip_to_gcs(**kwargs):
        ...
        logging.info(f'connect in bucjket: {bucket_name}')
    ...
    def delete_folder(folder_path, **kwargs):
        
        """
        Apaga todos os objetos no GCS que tenham o prefixo igual a {folder_path}.
        
        Args:
            folder_path (str): Caminho do diretório no GCS que deseja apagar
        """
        params : ParamsDict = kwargs["params"]
